...
export function Masthead({ isStaging = false }: MastheadProps) {
  const [isMastheadContentVisible, setIsMastheadContentVisible] = useState(false);
    ...
    >
      <div className="px-3 lg:container lg:mx-auto lg:px-6">
        <div className="flex gap-1">
          <svg
            ...
            height="32"
            viewBox="0 0 32 32"
            className="h-7 w-5 shrink-0 align-top"
          >
          ...
          <div className="flex flex-wrap items-start gap-x-1 pt-1.5">
            <span>
              ...
              {isStaging && <b className="ml-1">[NOTE: THIS IS A STAGING WEBSITE]</b>}
            </span>
            <button
              className="flex cursor-pointer items-start text-[#2f60ce] bg-transparent border-none p-0"
              aria-expanded={isMastheadContentVisible}
              aria-controls="sgds-masthead-content"
              onClick={() => setIsMastheadContentVisible(!isMastheadContentVisible)}
            >
              ...
              <svg
                ...
                viewBox="0 0 20 20"
                fill="none"
                className={`block h-[21px] w-[12px] select-none self-center transition-all duration-300 ${
      ...
      {isMastheadContentVisible && (
        <div
          ...
          className="px-3 pb-8 pt-4 text-[#474747] lg:container lg:mx-auto lg:px-6 lg:pb-12 lg:pt-10"
        >
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-40">
            <div className="flex gap-2 text-[0.6875rem] lg:gap-4 lg:text-base">
              ...
              <div>
                ...
                <p className="leading-[1.2rem] lg:leading-6">
                  Government agencies communicate via .gov.sg websites (e.g. go.gov.sg/open).{' '}
                  <a
                    href="https://www.gov.sg/trusted-sites#govsites"
                    className="inline-flex items-center text-[#2f60ce] hover:text-[#4371d6]"
                  ...
                  >
                    ...
                    <svg
                      ...
                      height="18"
                      viewBox="0 0 32 32"
                      className="ml-0.5 w-3 fill-[#2f60ce] hover:fill-[#4371d6] lg:w-auto"
                    >
            ...
            <div className="flex gap-2 text-[0.6875rem] lg:gap-4 lg:text-base">
              <div className="-mt-[0.1rem]">
                <svg
                  ...
                  viewBox="0 0 15 18"
                  fill="none"
                  className="inline-block w-3 lg:w-[1.125rem]"
                >
              ...
              <div>
                ...
                <p>
                  ...
                  <svg
                    ...
                    viewBox="0 0 15 18"
                    fill="none"
                    className="mb-[0.1875rem] inline-block h-[0.6rem] w-[0.6rem] lg:h-auto lg:w-auto"
                  >
                    <path fill="#242425" d="M14.1663 9.00008C14.1663 8.08091 13.4188 7.33342 12.4997 7.33342H11.6663V4.83342C11.6663 2.53591 9.79717 0.666748 7.49967 0.666748C5.20217 0.666748 3.33301 2.53591 3.33301 4.83342V7.33342H2.49967C1.58051 7.33342 0.833008 8.08091 0.833008 9.00008V15.6667C0.833008 16.5859 1.58051 17.3334 2.49967 17.3334H12.4997C13.4188 17.3334 14.1663 16.5859 14.1663 15.6667V9.00008ZM4.99967 4.83342C4.99967 3.45508 6.12134 2.33341 7.49967 2.33341C8.87801 2.33341 9.99967 3.45508 9.99967 4.83342V7.33342H4.99967V4.83342Z" />
                  </svg>
